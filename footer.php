    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-12 col-md-4">
          <div class="widget-a">
              <img class="logo-footer" src="assets/img/logo3.png" alt="logo">
            <br><br>
            <div class="w-body-a">
            ...
            <div class="w-footer-a">
              <ul class="list-unstyled">
                <li class="color-a">
                  <span class="color-text-a">Telémovel: </span>+351960548952
                </li>
                <li class="color-a">
        ...
        <div class="col-md-12">
          ...
          <div class="copyright-footer">
            <p class="copyright color-text-a">
              &copy; Copyright
              <span class="color-a">HomeFinder &reg;</span> All Rights Reserved.
            </p>
          </div>
          <!-- <div class="credits"> -->
            <!--
